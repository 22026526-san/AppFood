...
const NoticeScreen = () => {
  ...
  const getNotice = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/admin/get_notice`, {
        method: 'POST',
        headers: {
      ...
      console.error('Lỗi khi cập nhật notices:', err);
    }
  };
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <View style={{ display: 'flex', flexDirection: 'row', gap: 10, alignItems: 'center' }}>
            ...
            <Text style={{ fontSize: 22, color: '#000000d2', fontWeight: 'bold' }}>Notices</Text>
        ...
        <ScrollView contentContainerStyle={{ paddingLeft: 20, paddingRight: 20 }}
          ...
          <View style={{ marginTop: 286, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 16, color: '#ff5e00b0' }} >There are no notification.</Text>
          </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView  onScroll={handleScroll}
        ...
        <View style={{ marginTop: 12 }}>
          <NoticeCard data={data} onUpdate={getNotice}></NoticeCard>
        </View>
